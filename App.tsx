...
const App: React.FC = () => {
  ...
  const [settings, setSettings] = useState<ClinicSettings>({
    ...
    aiPhoneSettings: {
      ...
      initialGreeting: "Hola, soy Sara de MediClinic Premium. ¿En qué puedo ayudarte hoy?",
      systemPrompt: "Eres la recepcionista experta de la clínica MediClinic Premium.", 
      instructions: "Verifica disponibilidad.",
      testSpeechText: "Hola, soy Sara. Es un placer saludarte. Estoy aquí para gestionar tus citas.", 
      voiceName: "Zephyr", 
      voicePitch: 1.0, 
      voiceSpeed: 1.0, 
      temperature: 0.7, 
