  ...
  return (
    <div className="w-full flex flex-col p-6 gap-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setIsCreating(true)} className="h-10 px-6 bg-primary text-white rounded-md font-bold shadow-sm flex items-center gap-2 hover:bg-primary-dark transition-all">
